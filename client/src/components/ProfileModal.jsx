        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          >
            ...
            <div className="flex justify-end space-x-3 pt-6">
              ...
              <button
                type="submit"
                className="px-4 py-2 bg-gradient-to-r from-pink-500 to-indigo-600 text-white rounded-lg hover:from-indigo-600 hover:to-purple-700 transition duration-300 cursor-pointer"
              >
                {" "}
                Save changes{" "}
              </button>
